...
//par3EntityPlayer.addPotionEffect(new EffectInstance(Effects.HASTE, 600, 2));
	...
	public static final RegistryObject<HoeItem> RUBY_HOE = ITEMS.register("ruby_hoe", () -> new HoeItem(ToolMaterials.TOOL_RUBY, 0, new Item.Settings().group(ItemGroup.TOOLS)));
	
	
	public static final RegistryObject<SwordItem> AMETHYST_SWORD = ITEMS.register("emerald_sword", () -> new SwordItem(featurecreep.content.FCItems.AMETHYST_TOOL_MATERIAL, 0, -2.4F, new Item.Settings().group(ItemGroup.COMBAT)));
	public static final RegistryObject<PickaxeItem> AMETHYST_PICKAXE = ITEMS.register("emerald_pickaxe", () -> new PickaxeItem(featurecreep.content.FCItems.AMETHYST_TOOL_MATERIAL, 0, 0, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final RegistryObject<ShovelItem> AMETHYST_SHOVEL = ITEMS.register("emerald_shovel", () -> new ShovelItem(featurecreep.content.FCItems.AMETHYST_TOOL_MATERIAL, 0, 0, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final RegistryObject<HoeItem> AMETHYST_HOE = ITEMS.register("emerald_hoe", () -> new HoeItem(featurecreep.content.FCItems.AMETHYST_TOOL_MATERIAL, 0, new Item.Settings().group(ItemGroup.TOOLS)));
	...
	public static final RegistryObject<HoeItem> TIGERS_EYE_HOE = ITEMS.register("tigers_eye_hoe", () -> new HoeItem(ToolMaterials.TOOL_TIGERS_EYE, 0, new Item.Settings().group(ItemGroup.TOOLS)));
