...
public class FCHoe extends HoeItem implements FCItemAPI
{
	...
	public FCHoe(int id, String modid, String name, ItemGroup group, FCToolMaterial material, int attackDamage, int attackSpeed)
	{
		super(material, attackSpeed, new Item.Settings().group(group));
		public_modid = modid;
		public_name = name;
		registerModels(this);
