...
public class FCArmourMaterial {
	...
	public RegistryEntry<ArmourMaterial> get() {
		RegistryEntry<SoundEffect> vainilla_sound = this.sound.getEntry();
        ...
        return GameRegistries.registerReference(BuiltInRegistries.var_unknown_123865, new ResourceLocation(name), mat);
