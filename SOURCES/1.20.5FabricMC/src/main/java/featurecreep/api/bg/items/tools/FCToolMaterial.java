...
//return this.getToolRepairIngredient();
	...
	@Override
	public RegistryTagKey<Block> def_unknown_145091() {
		// TODO Auto-generated method stub
	
		if(getToolHarvestLevel() == 0) {
			return BlockTags.var_unknown_124190;//Prioritising butter as itll likely have more supported blocks
		} else if(getToolHarvestLevel() == 1) {
			return BlockTags.var_unknown_124187;
		}else if(getToolHarvestLevel() == 2) {
			return BlockTags.var_unknown_124186;
		}else if(getToolHarvestLevel() == 3) {
			return BlockTags.var_unknown_124184;
		}
			return BlockTags.var_unknown_124183;//Mine everything else for now. FC Blocks still rely on harvest level to be mined for now
