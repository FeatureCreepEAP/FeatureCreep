...
public class TransformerTargets {
	...
	public static String[] denylisted_packages = { "net.minecraftforge.", "net.minecrell.terminalconsole.",
			...
			"cpw.mods.util.LambdaExceptionUtils", "cpw.mods.niofs.union", "cpw.mods.cl", "cpw.mods.modlauncher",
			"org.antlr.v4", "META-INF.", "oshi.", "io.netty.", // Could there be more Netty? not
			...
			"org.apache.http", "javassist.", "org.jboss.", "com.asbestosstar.AssistMixer",
			"com.asbestosstar.assistremapper.", "com.asbestosstar.cpiojava", "com.asbestosstar.dnfjava",
