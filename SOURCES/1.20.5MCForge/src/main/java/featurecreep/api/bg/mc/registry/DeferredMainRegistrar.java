...
public final class DeferredMainRegistrar {
    ...
    public static <T> DeferredHolder<T> register(
        ...
        if (committed) {
            throw new IllegalStateException("Tried to register after commit: " + key.location());
        }
        ...
        TASKS.add(() -> {
            ...
            if (value == null) {
                throw new IllegalStateException("Factory returned null for " + key.location());
            }

            T registered = Registry.register(registry, key.location(), value);
            holder.bind(registered);
        });
    ...
    public static DeferredHolder<Item> registerItem(
        ...
        TASKS.add(() -> {
            ...
            Item registered = Registry.register(BuiltInRegistries.ITEM, id, value);
            holder.bind(registered);
        });
    ...
    public static DeferredHolder<Block> registerBlock(
        ...
        TASKS.add(() -> {
            ...
            Block registered = Registry.register(BuiltInRegistries.BLOCK, id, value);
            holder.bind(registered);
        });
