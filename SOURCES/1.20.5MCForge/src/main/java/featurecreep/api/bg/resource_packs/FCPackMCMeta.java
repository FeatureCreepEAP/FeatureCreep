...
public class FCPackMCMeta {
	...
	public FCPackMCMeta(int pack_version, String description, List<String> enabledFeatures,
			List<String> supportedFormats, List<String> blockFilters, List<Overlay> overlays,
	...
	public static FCPackMCMeta fromModelNode(ModelNode node) {
		...
		return new FCPackMCMeta(packFormat, description, enabledFeatures, supportedFormats, blockFilters, overlays,
				additionalLanguages);
	}
