...
import game.ResourceMetadataSerialiser;
import game.metaResourceMetadataSection;
...
public interface VainillaResourcePack extends IResourcePack {
	...
	@Vainilla
	@Override
	public default <T extends metaResourceMetadataSection> T getMetadataSection(ResourceMetadataSerialiser var1, String var2)
			throws IOException {
		// TODO Auto-generated method stub
	
		Gson gson = new Gson();
		JsonObject obj = gson.getAdapter(JsonObject.class).fromJson(getPackMCMetaInfo().asJSON());
		 return var1.readMetadata(var2, obj);
	}
@Vainilla
	@Override
	public default BufferedImage getIcon() throws IOException {
		// TODO Auto-generated method stub
		Supplier<InputStream> png = this.getPackPng();
		if(png==null) {return null;}
		InputStream stream = png.get();
		if(stream!=null) {
		return TextureUtil.readImage(stream);
		}
		return null;
	}
	...
	@Vainilla
	@Override
	public default boolean hasResource(ResourceLocation arg1) {
		// TODO Auto-generated method stub
		try {
	...
	@Vainilla
	@Override
	public default InputStream getResource(ResourceLocation arg1) throws IOException {
		// TODO Auto-generated method stub
		FCResourceType type = FCResourceType.checkBuiltIn("assets/");
