...
public interface ToolsAPI<T> extends FCItemAPI<T> {
	...
	public default void initialise(int id, String modid, String name, UnifiedItemGroupGetter group,
			FCToolMaterial material, int attackDamage, int attackSpeed) {
	...
	public default void setFCToolMaterial(FCToolMaterial mat) {
		holder().mat = mat;
	}

	public default void setToolAttackDamage(int damage) {
		holder().damage = damage;
	}

	public default void setAttackSpeed(int attackspeed) {
		holder().attackspeed = attackspeed;
	}

	public default FCToolMaterial getFCToolMaterial() {
		return holder().mat;
	}

	public default int getToolAttackDamage() {
		return holder().damage;
	}

	public default int getAttackSpeed() {
		return holder().attackspeed;
	}
