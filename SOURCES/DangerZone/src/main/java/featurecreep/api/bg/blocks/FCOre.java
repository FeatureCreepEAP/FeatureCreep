  ...
  System.out.println("Block Broken");
    for (int i = 0; i < arr.size(); i++) {
    	...
    	if (loot instanceof featurecreep.api.bg.blocks.drop.SelfBlockDropArrayObject) {
            ...
            executeDropItem(new FCWorld(p.world), new FCBlockPos(x, y, z),this);//for a sec i thought i had to declare a whole new vanila item, turns out not
          } else {
