...
static {
	...
	public static JarFile getGameJar() {
		...
		List<String> compat = ClassPathUtils.findJarFilesWithPackage(cp, "dangerzone.thingstodo");
	...
	public static JarFile getShadow() {
		String target = FeatureCreep.gamepath + "/usr/share/.shadows/dz_" + FeatureCreep.game_version + ".jar";
	...
	public static JarFile getFCIShadow() {
		String target = FeatureCreep.gamepath + "/usr/share/.fci_shadows/dz_" + FeatureCreep.game_version + "-"
