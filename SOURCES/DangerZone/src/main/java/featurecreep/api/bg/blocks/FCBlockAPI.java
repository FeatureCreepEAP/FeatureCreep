...
@Override
 public default void registerModels() {
    ...
    if (getSingleSided()) {
      setUpTextureName(FeatureCreep.gamepath + "/resourcepacks/fcpack_8/assets/" + this.getModId() + "/textures/blocks/" + this.getUnlocName() + ".png");
      setDownTextureName(FeatureCreep.gamepath + "/resourcepacks/fcpack_8/assets/" + this.getModId() + "/textures/blocks/" + this.getUnlocName() + ".png");
      setWestTextureName(FeatureCreep.gamepath + "/resourcepacks/fcpack_8/assets/" + this.getModId() + "/textures/blocks/" + this.getUnlocName() + ".png");
      setEastTextureName(FeatureCreep.gamepath + "/resourcepacks/fcpack_8/assets/" + this.getModId() + "/textures/blocks/" + this.getUnlocName() + ".png");
      setNorthTextureName(FeatureCreep.gamepath + "/resourcepacks/fcpack_8/assets/" + this.getModId() + "/textures/blocks/" + this.getUnlocName() + ".png");
      setSouthTextureName(FeatureCreep.gamepath + "/resourcepacks/fcpack_8/assets/" + this.getModId() + "/textures/blocks/" + this.getUnlocName() + ".png");
      System.out.println(getUpTextureName());

    } else {

      setUpTextureName(FeatureCreep.gamepath + "/resourcepacks/fcpack_8/assets/" + this.getModId() + "/textures/blocks/" + this.getUnlocName() + "_up.png");
      setDownTextureName(FeatureCreep.gamepath + "/resourcepacks/fcpack_8/assets/" + this.getModId() + "/textures/blocks/" + this.getUnlocName() + "_down.png");
      setWestTextureName(FeatureCreep.gamepath + "/resourcepacks/fcpack_8/assets/" + this.getModId() + "/textures/blocks/" + this.getUnlocName() + "_west.png");
      setEastTextureName(FeatureCreep.gamepath + "/resourcepacks/fcpack_8/assets/" + this.getModId() + "/textures/blocks/" + this.getUnlocName() + "_east.png");
      setNorthTextureName(FeatureCreep.gamepath + "/resourcepacks/fcpack_8/assets/" + this.getModId() + "/textures/blocks/" + this.getUnlocName() + "_north.png");
      setSouthTextureName(FeatureCreep.gamepath + "/resourcepacks/fcpack_8/assets/" + this.getModId() + "/textures/blocks/" + this.getUnlocName() + "_south.png");
...
get().onFoodEaten(e.get());
	...
	@Override
	public default void executeOnBlockBroken(AbstractEntity ent, FCBlockPos pos, FCBlockAPI block, int wasbid) {get().onBlockBroken((Player)ent.get(), ent.get().dimension, pos.getXLocation(), pos.getYLocation(), pos.getZLocation(), wasbid);};
	...
	public default void executeBumpedBlock(AbstractEntity e, FCWorld w, FCBlockPos pos) {get().bumpedBlock(e.get(), w.get(), 0, pos.getXLocation(), pos.getYLocation(), pos.getZLocation());}
	public default void bumpedBlock(AbstractEntity e, FCWorld w, FCBlockPos pos) {}
	public default void executeOnBroken(AbstractPlayer player, int dimension, FCBlockPos pos) {get().onBlockBroken(player.get(),0, pos.getXLocation(), pos.getYLocation(), pos.getZLocation(), 0);}
	...
	public default void onPlaced(FCWorld w,FCBlockPos pos) {get().onBlockPlaced(w.get(), 0, pos.getXLocation(), pos.getYLocation(), pos.getZLocation());}//Gotta update the last 2 args later
...
result.add(getDropArrayObjects()[i]);
	...
	public default void executeOnStepped(AbstractEntity e, FCWorld w, FCBlockPos pos) {get().doSteppedOn(e.get(), w.get(), 0, pos.getXLocation(), pos.getYLocation(), pos.getZLocation());}

	public default void onStepped(AbstractEntity e, FCWorld w, FCBlockPos pos) {}
	 public default void executeDropItem(FCWorld worl, FCBlockPos pos, BlockOrItem drop) {worl.get().createEntityByName(DangerZone.blockitemname, 0, (double) pos.getXLocation() + 0.5f, (double) pos.getYLocation() + 0.5f, (double) pos.getZLocation() + 0.5f);}
