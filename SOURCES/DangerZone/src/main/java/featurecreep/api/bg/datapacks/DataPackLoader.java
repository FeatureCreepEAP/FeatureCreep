...
public class DataPackLoader {
	...
	public static String datapacklocation = new String(FeatureCreep.gamepath + "/resourcepacks/fcdatapack3/");// We can
																												// hardcode
																												// a
																												// datapack
																												// name
	...
	public static void onInitialise() {
		...
		// MinecraftClient.getInstance().getResourcePackManager().addPackFinder(new
		...
		// MinecraftClient.getInstance().getResourcePackManager().registerProvider(new
		// FCPackLoad(new File(PackLoader.fc_pack_location)));
