...
public class CraftObject {
	...
	public CraftObject (BlockOrItem result, int quantity, BlockOrItem ingredient0, BlockOrItem ingredient1, BlockOrItem ingredient2, BlockOrItem ingredient3, BlockOrItem ingredient4, BlockOrItem ingredient5, BlockOrItem ingredient6, BlockOrItem ingredient7, BlockOrItem ingredient8)
	{
	    ...
	    if (result != null) {
	      ...
	      this.quantity = quantity;
			if (result instanceof FCBlockAPI) {resulttype="block";}else {resulttype="item";}

	      
	      
	      
	    }else {System.out.println("Attempted to register a recipe with a null output, it will be discarded");}
