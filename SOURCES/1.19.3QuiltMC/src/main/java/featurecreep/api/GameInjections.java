...
public class GameInjections {
	...
	public static SuperLoader super_loader = SuperLoader.QUILTMC;// Need to detect this eventually
	...
	public static int texture_pack_version = 12;
	public static int data_pack_version = 10;
