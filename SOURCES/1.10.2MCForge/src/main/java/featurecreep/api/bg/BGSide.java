...
public class BGSide {
	...
	public static ExecutionSide getExecutionSide() {
		//We will soon get a config for Plugin (Server side specific) and client only stuff (for connecting to a nonFC server)
	return BGSuperLoader.getExecutionSide();
	}
	
	//Currently only works for client/client_only(to be implemented) and not custom ones
