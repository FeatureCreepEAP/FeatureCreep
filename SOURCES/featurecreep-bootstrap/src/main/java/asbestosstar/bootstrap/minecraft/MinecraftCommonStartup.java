...
public class MinecraftCommonStartup {
    ...
    static {
        ...
        // Note: Flat mods handle their own transformers internally via the ClassLoader hook.
        // They do not support Agents/Premains.
        System.out.println("Loading Flat Mods :");
        BootstrapCommon.flatloader.loadMods();

        // Check if Hotswap is needed by the Module Loader (Agents are only supported here)
        ...
        if (moduleHotswap) {
            ...
            // Transformer classes defined in fcflat.properties are loaded automatically during loadMods().
        }
