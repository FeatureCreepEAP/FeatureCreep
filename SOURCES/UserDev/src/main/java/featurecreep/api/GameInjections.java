...
public class GameInjections {
	...
	//TODOS LOS NULLS SON  MARCADORES DE POSITION SIN EMBARGO INSTRUMENTATION ES NORMALMENTE NULL CUANDO NO ESTAS EN MODIO AGENTE
	public static boolean agent_mode = false;
	public static boolean debug_mode=false;
	public static Path gamepath=null;
	...
	public static ActiveMapping mappings=null;// This is the default active mappings
	public static SuperLoader super_loader=null;// Need to detect this eventually
