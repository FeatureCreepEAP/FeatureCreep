...
public class FCPickaxeAsDMR extends FCItemAsDMR<FCPickaxeAsDMR> implements ToolsAPI<FCPickaxeAsDMR> {
	...
	public FCPickaxeAsDMR(int id, String modid, String name, UnifiedItemGroupGetter group, FCToolMaterial material,
...
//Do not use
	public Object get() {
		...
		return new FCPickaxe(node.get("id").asInt(), node.get("modid").asString(), node.get("item_name").asString(),
