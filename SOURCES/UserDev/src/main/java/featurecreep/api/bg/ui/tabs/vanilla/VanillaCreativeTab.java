...
{
	public String tabname; //Forgot this existed when making ItemGroup Holder, but after looking at it is may be good to keep as an intermediary so will be used in Global Registries
