...
//  }
	...
	public static boolean ItemKeyExistsInRegistry(String registry_name) {
		return false; // Userdev does not need to return anything , this should work in production
						// though
	}

	// public static Block getBlockFromGameRegistries(String registry_name) //We
	// also need a Number ID version of this
	// { }

	// public static Block getBlockFromGameRegistries(int id) { return
	// Blocks.getBlock(id); }
...
//  public static Object getItemGroupByID(int id) {
	...
	// public static Biome getBiomeFromGameRegistries(String registry_name) //We
	// also need a Number ID version of this
	// { }
