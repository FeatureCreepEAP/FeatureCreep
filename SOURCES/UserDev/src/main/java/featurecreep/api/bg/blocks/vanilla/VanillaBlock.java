...
public class VanillaBlock implements FCBlockAPI<VanillaBlock> {
	...
	// public BlockState state; //BE EVEN MORE CAREFUL WITH THIS, MC SPECIFC TO NEW
	// VERSIONS
...
//		this (block.get(), block.get().getDefaultState(),  registry_name);
	 ...
	 * 
	 * @Override public Block get() { return vanilla_block; //BE VERY CAREFUL }
	 * 
	 * public BlockState getFCBlockState() //BE EVEN MORE CAREFUL WITH THIS, MC
	 * SPECIFC TO NEW VERSIONS { return state; }
	 * 
	 */
