...
static {
	...
	public static JarFile getShadow() {
		String target = FeatureCreep.gamepath + "/usr/share/.shadows/mc_rift_" + FeatureCreep.game_version + ".jar";
	...
	public static JarFile getFCIShadow() {
		String target = FeatureCreep.gamepath + "/usr/share/.fci_shadows/mc_rift_" + FeatureCreep.game_version + "-"
