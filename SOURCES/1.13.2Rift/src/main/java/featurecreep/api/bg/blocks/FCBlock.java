...
public BlockFieldHolder holder = new BlockFieldHolder();
  ...
  @Override
	public void onMinedSucessfully(final World world, final Player player, final BlockPos pos,
			final BlockPropertiesData state, @Nullable final TileEntity te, final ItemStack stack) {
