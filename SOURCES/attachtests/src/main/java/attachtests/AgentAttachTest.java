...
public class AgentAttachTest {
	...
	public static void main(String[] args) {
		try {
			String jarLocation = new File(
					AgentAttachTest.class.getProtectionDomain().getCodeSource().getLocation().toURI()).getPath();
	...
	public static void agentmain(String agentArgs, Instrumentation inst) {
		...
		// For example, you can use the Instrumentation instance to redefine classes,
		// etc.
	}
}
