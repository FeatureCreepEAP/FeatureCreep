 ...
 */
public final class PKZipEntryResource implements Resource {
    private final JarFile jarFile;
    private final String relativePath;
    private final String entryName;
    private final URL resourceURL;

    PKZipEntryResource(final JarFile jarFile, final String name, final String relativePath, final URL resourceURL) {
