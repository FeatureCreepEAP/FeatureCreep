...
public class SuperLoader {
	...
	public static SuperLoader RISUGAMIS_MODLOADER = new SuperLoader("Risugami's ModLoader", LoaderFamily.RISUGAMI,
			Software.MINECRAFT);
	public static SuperLoader MINECRAFTFORGE = new SuperLoader("MinecraftForge", LoaderFamily.RISUGAMI,
			Software.MINECRAFT);
	...
	public static SuperLoader MEDDLE = new SuperLoader("Meddle", LoaderFamily.OTHER, Software.MINECRAFT);// For
																											// snaploader
																											// as well
	public static SuperLoader LITLAUNCHMC = new SuperLoader("LitLaunchMC", LoaderFamily.OTHER, Software.MINECRAFT);// Only
																													// For
																													// LitLaunch
																													// Minecraft
	public static SuperLoader ROPEMC = new SuperLoader("RopeMC", LoaderFamily.OTHER, Software.MINECRAFT);
	public static SuperLoader VANILLA_MINECRAFT = new SuperLoader("minecraft", LoaderFamily.JBOSS_MODULES,
			Software.MINECRAFT);
	public static SuperLoader DANGERZONE_BUILTIN_LOADER = new SuperLoader("dangerzone",
			LoaderFamily.DANGERZONE_BUILTIN_LOADER, Software.DANGERZONE);
	public static SuperLoader HEARTS_OF_IRON_IV_BUILTIN_LOADER = new SuperLoader("hearts_of_iron_iv",
			LoaderFamily.CLAUSEWITZ_BUILTIN_LOADER, Software.HEARTS_OF_IRON_IV);
	...
	public static class LoaderFamily {
		...
		public static LoaderFamily JBOSS_MODULES = new LoaderFamily("JBoss Modules"); // For Vainilla Minecraft,JBoss
																						// Forge Furnace, and Most other
																						// WildFly or JBoss stuff
		public static LoaderFamily AGENT = new LoaderFamily("Java Agent"); // Java Agent based loaders including
																			// SpringLoaded atm
