...
public class FCArmourMaterial {
	...
	public RegistryEntry<ArmourMaterial> get() {
        ...
        List<ArmourMaterial.ArmourLayer> $$7 = List.of(new ArmourMaterial.ArmourLayer(ResourceLocation.parse(name)));
        ...
        return GameRegistriesInterface.registerReference(BuiltInRegistries.ARMOUR_MATERIAL, ResourceLocation.parse(name), mat);
