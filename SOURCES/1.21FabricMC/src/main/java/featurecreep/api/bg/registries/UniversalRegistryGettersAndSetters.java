...
public class UniversalRegistryGettersAndSetters {
	...
	public static void registerItem(Item item, String registry_name, CreativeTab default_tab, int id) {
		RegistryInterface.register(BuiltInRegistries.ITEMS, ResourceLocation.parse(registry_name), item);
	...
	public static void registerBlock(Block block, String registry_name, CreativeTab default_tab, int id) {
		RegistryInterface.register(BuiltInRegistries.block, ResourceLocation.parse(registry_name), block);
		RegistryInterface.register(BuiltInRegistries.ITEMS, ResourceLocation.parse(registry_name),
