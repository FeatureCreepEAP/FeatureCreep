...
public class UniversalRegistryGettersAndSetters {
	...
	public static FCItemAPI getFCItembyID(int id) {
		if (GlobalRegistries.getItemByID(id) != null) {
			...
			return new VanillaItem(GameRegistries.getItemFromGameRegistries(id),
					BuiltInRegistries.ITEMS.getName(GameRegistries.getItemFromGameRegistries(id)).toString());
		}

	}

	public static void registerItem(Item item, String registry_name, CreativeTab default_tab, int id) {
		game.GameRegistries.register(BuiltInRegistries.ITEMS, ResourceLocation.def_unknown_11017_(registry_name), item);
	...
	public static FCBlockAPI getFCBlockbyID(int id) {
		if (GlobalRegistries.getBlockByID(id) != null) {
			...
			return new VanillaBlock(GameRegistries.getBlockFromGameRegistries(id),
					BuiltInRegistries.block.getName(GameRegistries.getBlockFromGameRegistries(id)).toString());
		}

	}

	public static void registerBlock(Block block, String registry_name, CreativeTab default_tab, int id) {
		game.GameRegistries.register(BuiltInRegistries.block, ResourceLocation.def_unknown_11017_(registry_name), block);
		game.GameRegistries.register(BuiltInRegistries.ITEMS, ResourceLocation.def_unknown_11017_(registry_name),
