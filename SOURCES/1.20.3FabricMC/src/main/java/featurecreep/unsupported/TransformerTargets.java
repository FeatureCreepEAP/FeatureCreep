...
public class TransformerTargets {
	...
	public static String[] denylisted_packages = { "net.minecrell.terminalconsole.", "net.fabricmc.api",
			"net.fabricmc.impl", "com.llamalad7.mixinextras", "net.jodah.", "com.electronwill.nightconfig.",
			...
			"org.apache.http", "org.slf4j"// maybe too much because of other slf4j?
