...
public class FCArmourMaterial {
	...
	public ArmorMaterial get() {
		...
		ArmorMaterial material = new ArmorMaterial(this.durability, defense, this.enchantability, equipSound,
				(float) this.toughness, (float) this.knockback_resistance, repairTag, assetId);
