...
public class FCSwordAsDMR extends FCItemAsDMR<FCSwordAsDMR> implements ToolsAPI<FCSwordAsDMR> {
	...
	public FCSwordAsDMR(int id, String modid, String name, UnifiedItemGroupGetter group, FCToolMaterial material,
	...
	public Item get() {
		...
		return new FCSword(node.get("id").asInt(), node.get("modid").asString(), node.get("item_name").asString(),
