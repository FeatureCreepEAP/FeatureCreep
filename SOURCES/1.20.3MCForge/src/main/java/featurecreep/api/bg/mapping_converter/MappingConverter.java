...
public class MappingConverter {
	...
	//full_class_name should be the full class name in FeatureCreep intermediary mappings seperated with . for package and $ for subclass
	...
	//full_class_name should be the full class name in preferred format and it returns featurecreep intermediary mappings seperated with . for package and $ for subclass
	...
	//full_class_name should be the full class name in default format and it returns featurecreep intermediary mappings seperated with . for package and $ for subclass
