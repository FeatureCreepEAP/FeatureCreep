...
public class ActiveMapping {
	...
	public static ActiveMapping PARCHSRG = new ActiveMapping("parchsrg"); // SRG But with Moj/Parch classnames instead
																			// of the c_123 class names
	...
	public static ActiveMapping fromTransformer(byte[] bytes, String class_name) {
		...
		} else if (classname.startsWith("net.minecraft.src.C_")) {// the C_ is required because some mappings like old
																	// mcp start with net.minecraft.src
			determained = true;
			return SRG;
