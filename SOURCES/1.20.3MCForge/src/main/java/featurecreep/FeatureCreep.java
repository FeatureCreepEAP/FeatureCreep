...
public static boolean debug_mode = false;	
	public static Path gamepath = FeatureCreepMCInit.gamepath;//The one for mcforge does not work too early sometimes or has other issues even if its suggested
