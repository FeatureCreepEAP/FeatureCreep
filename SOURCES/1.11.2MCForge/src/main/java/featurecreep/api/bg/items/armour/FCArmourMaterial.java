...
public FCArmourMaterial (int durability, ArmourProtectionValuesArray protection, int enchantability, String name, int toughness, int knockback_resistance, AbstractSoundEffect sound)
{
...
{
this(durability, protection, enchantability,name, toughness, knockback_resistance, sound);
}
...
public  int getFCTextureNumber(FCArmourSlot slot)
{
    ...
    public SoundPoolComponent getEquipSound() // Sound I will do Later
    {
    	return sound.get();
    }
