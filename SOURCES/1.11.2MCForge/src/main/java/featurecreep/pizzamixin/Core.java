...
System.out.println("trying to inject");			
    	...
    	pool.insertClassPath(new ByteArrayClassPath("net.minecraft.entity.player.EnumPlayerModelParts",SerializationUtils.serialize(class_unknown_1559.class)));//Fix this soonEnumPlayerModelParts
//
