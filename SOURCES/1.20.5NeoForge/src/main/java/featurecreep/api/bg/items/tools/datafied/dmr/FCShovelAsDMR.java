...
public class FCShovelAsDMR extends FCItemAsDMR<FCShovelAsDMR> implements ToolsAPI<FCShovelAsDMR> {
	...
	@Override
	public featurecreep.api.bg.items.tools.ToolFieldHolder holder() {
		return holder;
	}

	public FCShovelAsDMR(int id, String modid, String name, UnifiedItemGroupGetter group, FCToolMaterial material,
	...
	public Item get() {
		...
		return new FCShovel(node.get("id").asInt(), node.get("modid").asString(), node.get("item_name").asString(),
