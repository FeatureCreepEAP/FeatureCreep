...
public class GameJar {
	...
	public static JarFile getShadow() {
		String target = FeatureCreep.gamepath + "/usr/share/.shadows/mc_neoforge_" + FeatureCreep.game_version + ".jar";
	...
	public static JarFile getFCIShadow() {
		String target = FeatureCreep.gamepath + "/usr/share/.fci_shadows/mc_neoforge_" + FeatureCreep.game_version + "-"
