...
public BlockFieldHolder holder = new BlockFieldHolder();
  ...
  @Override
  public void onMinedSucessfully(World world, Player player, BlockPos pos, IBlockstate iBlockstate, @Nullable TileEntity tileEntity, ItemStack stack) {
...
@Override
public boolean canHarvestBlock(IBlockstate iBlockstate, IBlockAccess iBlockAccess, BlockPos blockPos, Player player) {
    return true;
}
