...
public class OrespawnBasicFeatureParser {
	  ...
	  public static List<RegistryEntry<GenerationPlacement>> placed = new ArrayList<RegistryEntry<GenerationPlacement>>();
...
public static void applyOres(ChunkGenerator gen, StructureWorldGenerationAccessLevel world, Chunk chunk, NudgerBuildings structureAccessor)
{
	...
	for(int i=0; i<placed.size(); i++) {
		placed.get(i).comp_349().placeChecked(world, gen, chunkRandom, blockPos);
	}
	if(FeatureCreep.debug_mode) {
