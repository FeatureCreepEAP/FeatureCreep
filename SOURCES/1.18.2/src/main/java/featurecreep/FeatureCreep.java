...
public static boolean debug_mode = false;
	...
	public static Path[] modpaths = {new File(modpath).toPath(),new File(natively_mapped_mods_folder).toPath(), gamepath};//Add GamePath until i make better installer
...
loader.getTransformers().addAll(FeatureCreepMCInit.loader.getTransformers());
loader.loadMods();
