...
public class MethodTransformer extends TransformCall{
	...
	public MethodTransformer(Transformer next, MethodInfo oldMethodName, String substMethod, RemapperInstance mapper) throws CannotCompileException, NotFoundException {
		super(next, substMethod, mapper.getMethodFromClass("testMethod", "()", mapper.getClassFromPool("donotcreateclazzwithestenombe")));
	...
	public int transform(int pos, CodeIterator iterator,
