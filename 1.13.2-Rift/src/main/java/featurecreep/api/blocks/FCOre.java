...
public class FCOre extends OreBlock implements FCBlockAPI {
  ...
  public FCOre(int id, String modid, String name, ItemGroup group, VanillaBlockMaterial material, int strength, BlockDropArrayObject[] drops, Object ore_material) {
    super(Block.Settings.of(material.get).strength(strength/10, strength/10));
    public_modid = modid;
    public_name = name;
    registerModels(this);
...
resource = ore_material;
  ...
  @Override
  public void afterBreak(World world, PlayerEntity player, BlockPos pos, net.minecraft.BlockState state, @Nullable BlockEntity blockEntity, ItemStack stack) {
