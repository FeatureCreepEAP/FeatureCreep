...
public static List<DecoratedFeature> configed = new ArrayList <DecoratedFeature>();
...
public static void place(Biome biome) {
	...
	for (int f = 0; f < OrespawnBasicFeatureParser.configed.size(); f++) {
		...
		biome.method_8719(GenerationStep.Feature.UNDERGROUND_ORES, OrespawnBasicFeatureParser.configed.get(f));
