...
public class EnchantedHoe extends HoeItem {
	
		public EnchantedHoe(ToolMaterial tier, int attackDamageIn, float attackSpeedIn, Settings builderIn) {
		super(tier, attackSpeedIn, builderIn);
...
stack.addEnchantment(Enchantments.FOURTUNE, 5);
