...
public class FCShovel extends ItemSpade implements FCItemAPI<FCShovel>
{
	...
	public FCShovel(int id, String modid, String name, CreativeTabs group, FCToolMaterial material, int attackDamage, int attackSpeed)
	{
