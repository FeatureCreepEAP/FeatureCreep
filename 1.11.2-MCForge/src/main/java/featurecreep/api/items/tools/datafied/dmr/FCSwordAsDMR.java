...
@Override	public featurecreep.api.items.tools.ToolFieldHolder holder() {	return holder;	}
	...
	public FCSwordAsDMR(int id, String modid, String name, UnifiedItemGroupGetter group, FCToolMaterial material, int attackDamage, int attackSpeed)
	{
