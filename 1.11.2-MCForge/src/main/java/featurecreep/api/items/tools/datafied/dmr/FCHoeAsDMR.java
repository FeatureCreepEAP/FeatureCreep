...
public class FCHoeAsDMR extends FCItemAsDMR 
{
	...
	public FCHoeAsDMR(int id, String modid, String name, FCCreativeTab group, FCToolMaterial material, int attackDamage, int attackSpeed)
	{
super (id, modid,name, group);
	...
	public FCHoeAsDMR(int id, String modid, String name, VanillaCreativeTab group, FCToolMaterial material, int attackDamage, int attackSpeed)
	{
		super (id, modid,name, group);
		public_modid = modid;
		public_name = name;
