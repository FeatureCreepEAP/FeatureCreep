...
public class DustOre extends Block{
	...
	public DustOre(String name, Material material, float hardness, float resistance, int miningLevel, String tool, DimensionType dimension, int minY, int maxY, int group, int tries, Predicate<IBlockState> blockReplaced,Item drop)
	{
		super(material);
...
//this.getItemDropped(getDefaultState(), RANDOM, 1);
		...
		FeatureCreepMC.DUST_ORE.add(this);
