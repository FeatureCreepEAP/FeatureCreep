...
public class FeatureCreepMC
{
    ...
    public static void initi()
    {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(MOBZILLA_SCALE_HELMET, 1), new Object [] {
    	"XXX", "X X", "   ", 'X', FeatureCreepMC.MobzillaScale		
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(MOBZILLA_SCALE_CHESTPLATE, 1), new Object [] {
    	"X X", "XXX", "XXX", 'X', FeatureCreepMC.MobzillaScale		
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(MOBZILLA_SCALE_LEGGINGS, 1), new Object [] {
    	"XXX", "X X", "X X", 'X', FeatureCreepMC.MobzillaScale		
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(MOBZILLA_SCALE_BOOTS, 1), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(QUEEN_SCALE_HELMET, 1), new Object [] {
    	"XXX", "X X", "   ", 'X', FeatureCreepMC.QueenScale		
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(QUEEN_SCALE_CHESTPLATE, 1), new Object [] {
    	"X X", "XXX", "XXX", 'X', FeatureCreepMC.QueenScale	
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(QUEEN_SCALE_LEGGINGS, 1), new Object [] {
    			"XXX", "X X", "X X", 'X', FeatureCreepMC.QueenScale	
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(QUEEN_SCALE_BOOTS, 1), new Object [] {
    	"X X", "X X", "   ", 'X', FeatureCreepMC.QueenScale	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(MOTH_SCALE_HELMET, 1), new Object [] {
    			"XXX", "X X", "   ", 'X', FeatureCreepMC.MothScale	
    	});

    	GameRegistry.addShapedRecipe( new ItemStack(MOTH_SCALE_CHESTPLATE, 1), new Object [] {
    			"X X", "XXX", "XXX", 'X', FeatureCreepMC.MothScale		
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(MOTH_SCALE_LEGGINGS, 1), new Object [] {
    			"XXX", "X X", "X X", 'X', FeatureCreepMC.MothScale	
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(MOTH_SCALE_BOOTS, 1), new Object [] {
    	"XXX", "X X", "X X", 'X', FeatureCreepMC.MothScale	
    	});
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(PEACOCK_FEATHER_HELMET, 1), new Object [] {
    			"XXX", "X X", "   ", 'X', FeatureCreepMC.PEACKOCK_FEATHER	
    	});

    	GameRegistry.addShapedRecipe( new ItemStack(PEACOCK_FEATHER_CHESTPLATE, 1), new Object [] {
    			"X X", "XXX", "XXX", 'X', FeatureCreepMC.PEACKOCK_FEATHER		
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(PEACOCK_FEATHER_LEGGINGS, 1), new Object [] {
    			"XXX", "X X", "X X", 'X', FeatureCreepMC.PEACKOCK_FEATHER	
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(PEACOCK_FEATHER_BOOTS, 1), new Object [] {
    	"XXX", "X X", "X X", 'X', FeatureCreepMC.PEACKOCK_FEATHER	
    	});
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(PINK_TOURMALINE_HELMET, 1), new Object [] {
    			"XXX", "X X", "   ", 'X', FeatureCreepMC.PinkTourmaline	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(PINK_TOURMALINE_CHESTPLATE, 1), new Object [] {
    			"X X", "XXX", "XXX", 'X', FeatureCreepMC.PinkTourmaline	
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(PINK_TOURMALINE_LEGGINGS, 1), new Object [] {
    			"XXX", "X X", "X X", 'X', FeatureCreepMC.PinkTourmaline	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(PINK_TOURMALINE_BOOTS, 1), new Object [] {
    	"   ", "X X", "X X", 'X', FeatureCreepMC.PinkTourmaline	
    	});

    	GameRegistry.addShapedRecipe( new ItemStack(LAVA_EEL_HELMET, 1), new Object [] {
    			"XXX", "X X", "   ", 'X', FeatureCreepMC.LAVA_EEL	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(LAVA_EEL_CHESTPLATE, 1), new Object [] {
    			"X X", "XXX", "XXX", 'X', FeatureCreepMC.LAVA_EEL		
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(LAVA_EEL_LEGGINGS, 1), new Object [] {
    			"XXX", "X X", "X X", 'X', FeatureCreepMC.LAVA_EEL		
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(LAVA_EEL_BOOTS, 1), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(LAPIS_LAZUI_HELMET, 1), new Object [] {
    			"XXX", "X X", "   ", 'X', Blocks.LAPIS_BLOCK	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(LAPIS_LAZUI_CHESTPLATE, 1), new Object [] {
    			"X X", "XXX", "XXX", 'X', Blocks.LAPIS_BLOCK			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(LAPIS_LAZUI_LEGGINGS, 1), new Object [] {
    			"XXX", "X X", "X X", 'X', Blocks.LAPIS_BLOCK			
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(LAPIS_LAZUI_BOOTS, 1), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(ALUMINIUM_HELMET, 1), new Object [] {
    			"XXX", "X X", "   ", 'X', FeatureCreepMC.ALUMINIUM	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(ALUMINIUM_CHESTPLATE, 1), new Object [] {
    			"X X", "XXX", "XXX", 'X', FeatureCreepMC.ALUMINIUM			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(ALUMINIUM_LEGGINGS, 1), new Object [] {
    			"XXX", "X X", "X X", 'X', FeatureCreepMC.ALUMINIUM			
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(ALUMINIUM_BOOTS, 1), new Object [] {
    	"   ", "X X", "X X", 'X', FeatureCreepMC.ALUMINIUM		
    	});



    	GameRegistry.addShapedRecipe( new ItemStack(COPPER_HELMET, 1), new Object [] {
    			"XXX", "X X", "   ", 'X', FeatureCreepMC.COPPER_INGOT	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(COPPER_CHESTPLATE, 1), new Object [] {
    			"X X", "XXX", "XXX", 'X', FeatureCreepMC.COPPER_INGOT			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(COPPER_LEGGINGS, 1), new Object [] {
    			"XXX", "X X", "X X", 'X', FeatureCreepMC.COPPER_INGOT			
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(COPPER_BOOTS, 1), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(SILVER_HELMET, 1), new Object [] {
    			"XXX", "X X", "   ", 'X', FeatureCreepMC.SILVER_INGOT	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(SILVER_CHESTPLATE, 1), new Object [] {
    			"X X", "XXX", "XXX", 'X', FeatureCreepMC.SILVER_INGOT			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(SILVER_LEGGINGS, 1), new Object [] {
    			"XXX", "X X", "X X", 'X', FeatureCreepMC.SILVER_INGOT			
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(SILVER_BOOTS, 1), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(TIN_HELMET, 1), new Object [] {
    			"XXX", "X X", "   ", 'X', FeatureCreepMC.TIN_INGOT	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(TIN_CHESTPLATE, 1), new Object [] {
    			"X X", "XXX", "XXX", 'X', FeatureCreepMC.TIN_INGOT			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(TIN_LEGGINGS, 1), new Object [] {
    			"XXX", "X X", "X X", 'X', FeatureCreepMC.TIN_INGOT			
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(TIN_BOOTS, 1), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(PLATINUM_HELMET, 1), new Object [] {
    	"X X", "X X", "   ", 'X', FeatureCreepMC.PLATINUM_INGOT	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(PLATINUM_CHESTPLATE, 1), new Object [] {
    			"X X", "XXX", "XXX", 'X', FeatureCreepMC.PLATINUM_INGOT			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(PLATNIUM_LEGGINGS, 1), new Object [] {
    			"XXX", "X X", "X X", 'X', FeatureCreepMC.PLATINUM_INGOT			
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(PLATINUM_BOOTS, 1), new Object [] {
    	"   ", "X X", "X X", 'X', FeatureCreepMC.PLATINUM_INGOT		
    	});
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(RUBY_HELMET, 1), new Object [] {
    			"XXX", "X X", "   ", 'X', FeatureCreepMC.RUBY	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(RUBY_CHESTPLATE, 1), new Object [] {
    			"X X", "XXX", "XXX", 'X', FeatureCreepMC.RUBY			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(RUBY_LEGGINGS, 1), new Object [] {
    			"XXX", "X X", "X X", 'X', FeatureCreepMC.RUBY			
    	});

    	GameRegistry.addShapedRecipe( new ItemStack(RUBY_BOOTS, 1), new Object [] {
    	"   ", "X X", "X X", 'X', FeatureCreepMC.RUBY
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(AMETHYST_HELMET, 1), new Object [] {
    			"XXX", "X X", "   ", 'X', FeatureCreepMC.AMETHYST	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(AMETHYST_CHESTPLATE, 1), new Object [] {
    			"X X", "XXX", "XXX", 'X', FeatureCreepMC.AMETHYST			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(AMETHYST_LEGGINGS, 1), new Object [] {
    			"XXX", "X X", "X X", 'X', FeatureCreepMC.AMETHYST			
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(AMETHYST_BOOTS, 1), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(TIGERS_EYE_HELMET, 1), new Object [] {
    			"XXX", "X X", "   ", 'X', FeatureCreepMC.TIGERS_EYE	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(TIGERS_EYE_CHESTPLATE, 1), new Object [] {
    			"X X", "XXX", "XXX", 'X', FeatureCreepMC.TIGERS_EYE			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(TIGERS_EYE_LEGGINGS, 1), new Object [] {
    			"XXX", "X X", "X X", 'X', FeatureCreepMC.TIGERS_EYE			
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(TIGERS_EYE_BOOTS, 1), new Object [] {
    	"   ", "X X", "X X", 'X', FeatureCreepMC.TIGERS_EYE
    	});



    	GameRegistry.addShapedRecipe( new ItemStack(EMERALD_HELMET, 1), new Object [] {
    			"XXX", "X X", "   ", 'X', Items.EMERALD	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(EMERALD_CHESTPLATE, 1), new Object [] {
    			"X X", "XXX", "XXX", 'X', Items.EMERALD			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(EMERALD_LEGGINGS, 1), new Object [] {
    			"XXX", "X X", "X X", 'X', Items.EMERALD		
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(EMERALD_BOOTS, 1), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(EMERALD_PICKAXE, 1), new Object [] {
    	"XXX", " Y ", " Y ", 'X', Items.EMERALD, 'Y', Items.STICK	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(EMERALD_SWORD, 1), new Object [] {
    	" X ", " X ", " Y ", 'X', Items.EMERALD, 'Y', Items.STICK			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(EMERALD_HOLE, 1), new Object [] {
    	"XX ", " Y ", " Y ", 'X', Items.EMERALD, 'Y', Items.STICK			
    	});
    		


    	GameRegistry.addShapedRecipe( new ItemStack(EMERALD_SHOVEL, 1), new Object [] {
    	" X ", " Y ", " Y ", 'X', Items.EMERALD, 'Y', Items.STICK	
    	});



    	GameRegistry.addShapedRecipe( new ItemStack(AMETHYST_PICKAXE, 1), new Object [] {
    	"XXX", " Y ", " Y ", 'X', FeatureCreepMC.AMETHYST, 'Y', Items.STICK	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(AMETHYST_SWORD, 1), new Object [] {
    	" X ", " X ", " Y ", 'X', FeatureCreepMC.AMETHYST, 'Y', Items.STICK			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(AMETHYST_HOE, 1), new Object [] {
    	"XX ", " Y ", " Y ", 'X', FeatureCreepMC.AMETHYST, 'Y', Items.STICK			
    	});
    		


    	GameRegistry.addShapedRecipe( new ItemStack(AMETHYST_SHOVEL, 1), new Object [] {
    	" X ", " Y ", " Y ", 'X', FeatureCreepMC.AMETHYST, 'Y', Items.STICK	
    	});



    	GameRegistry.addShapedRecipe( new ItemStack(RUBY_PICKAXE, 1), new Object [] {
    	"XXX", " Y ", " Y ", 'X', FeatureCreepMC.RUBY, 'Y', Items.STICK	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(RUBY_SWORD, 1), new Object [] {
    	" X ", " X ", " Y ", 'X', FeatureCreepMC.RUBY, 'Y', Items.STICK			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(RUBY_HOE, 1), new Object [] {
    	"XX ", " Y ", " Y ", 'X', FeatureCreepMC.RUBY, 'Y', Items.STICK			
    	});
    		


    	GameRegistry.addShapedRecipe( new ItemStack(RUBY_SHOVEL, 1), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(SAPPHIRE_PICKAXE, 1), new Object [] {
    	"XXX", " Y ", " Y ", 'X', FeatureCreepMC.SAPPHIRE, 'Y', Items.STICK	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(SAPPHIRE_SWORD, 1), new Object [] {
    	" X ", " X ", " Y ", 'X', FeatureCreepMC.SAPPHIRE, 'Y', Items.STICK			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(SAPPHIRE_HOE, 1), new Object [] {
    	"XX ", " Y ", " Y ", 'X', FeatureCreepMC.SAPPHIRE, 'Y', Items.STICK			
    	});
    		


    	GameRegistry.addShapedRecipe( new ItemStack(SAPPHIRE_SHOVEL, 1), new Object [] {
    	" X ", " Y ", " Y ", 'X', FeatureCreepMC.SAPPHIRE, 'Y', Items.STICK	
    	});
    		
    		
    	GameRegistry.addShapedRecipe( new ItemStack(SAPPHIRE_HELMET, 1), new Object [] {
    			"XXX", "X X", "   ", 'X', FeatureCreepMC.SAPPHIRE	
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(SAPPHIRE_CHESTPLATE, 1), new Object [] {
    			"X X", "XXX", "XXX", 'X', FeatureCreepMC.SAPPHIRE			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(SAPPHIRE_LEGGINGS, 1), new Object [] {
    			"XXX", "X X", "X X", 'X', FeatureCreepMC.SAPPHIRE			
    	});
    		
    	GameRegistry.addShapedRecipe( new ItemStack(SAPPHIRE_BOOTS, 1), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(SAPPHIRE_BLOCK, 1), new Object [] {
    		"XXX", "XXX", "XXX", 'X', FeatureCreepMC.SAPPHIRE			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(RUBY_BLOCK, 1), new Object [] {
    			"XXX", "XXX", "XXX", 'X', FeatureCreepMC.RUBY			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(TIGERS_EYE_BLOCK, 1), new Object [] {
    			"XXX", "XXX", "XXX", 'X', FeatureCreepMC.TIGERS_EYE			
    	});

    	GameRegistry.addShapedRecipe( new ItemStack(TITANIUM_BLOCK, 1), new Object [] {
    			"XXX", "XXX", "XXX", 'X', FeatureCreepMC.TITANIUM			
    	});

    	GameRegistry.addShapedRecipe( new ItemStack(URANIUM_BLOCK, 1), new Object [] {
    			"XXX", "XXX", "XXX", 'X', FeatureCreepMC.URANIUM			
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(ALUMINIUM_BLOCK, 1), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(OPTIMISED_PICKAXE, 1), new Object [] {
    	"WXW", "VZ ", " Y ", 'X', Items.DIAMOND, 'Y', Items.STICK, 'Z', Items.IRON_INGOT, 'V', FeatureCreepMC.TITANIUM, 'W', FeatureCreepMC.STEEL_INGOT	
    	});

    	GameRegistry.addShapedRecipe( new ItemStack(OPTIMISED_SHOVEL, 1), new Object [] {
    	"WX ", "VZ ", " Y ", 'X', Items.DIAMOND, 'Y', Items.STICK, 'Z', Items.IRON_INGOT, 'V', FeatureCreepMC.TITANIUM, 'W', FeatureCreepMC.STEEL_INGOT	
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(DRINKABLE_GASOLINE_PETROL, 1), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(RAW_BACON, 2), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(BUTTER_FOOD, 4), new Object [] {
    	"   ", " Y ", " Y ", 'Y', Items.MILK_BUCKET	
    	});

    	GameRegistry.addShapedRecipe( new ItemStack(BUTTER_CANDY, 2), new Object [] {
    	"   ", " X ", " Y ", 'X', FeatureCreepMC.BUTTER_FOOD, 'Y', Items.SUGAR	
    	});



    	GameRegistry.addShapedRecipe( new ItemStack(CORN_DOG, 4), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(SALAD, 1), new Object [] {
    	"   ", " XW", "VYZ", 'X', FeatureCreepMC.TOMATO, 'Y', 	FeatureCreepMC.LETTUCE, 'W', FeatureCreepMC.RADISH , 'Z', Items.CARROT, 'V', Items.BOWL
    	});

    	GameRegistry.addShapedRecipe( new ItemStack(CHEESE, 4), new Object [] {
    	"   ", "YYY", " Y ", 'Y', Items.MILK_BUCKET	
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(BLT, 1), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(CRAB_PATTY, 1), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(SALTED_POPCORN, 1), new Object [] {
    	"   ", " X ", " Y ", 'X', FeatureCreepMC.Salt, 'Y',FeatureCreepMC.POPCORN 	
    	});

    	GameRegistry.addShapedRecipe( new ItemStack(BUTTERED_POPCORN, 1), new Object [] {
    	"   ", " X ", " Y ", 'X', FeatureCreepMC.BUTTER_FOOD, 'Y',FeatureCreepMC.POPCORN 	
    	});

    	GameRegistry.addShapedRecipe( new ItemStack(BUTTERED_AND_SALTED_POPCORN, 1), new Object [] {
    	" Z ", " X ", " Y ", 'X', FeatureCreepMC.BUTTER_FOOD, 'Y',FeatureCreepMC.POPCORN , 'Z',FeatureCreepMC.Salt	
    	});

    	GameRegistry.addShapedRecipe( new ItemStack(POPCORN_BAG, 1), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(GOLDEN_BREAD, 1), new Object [] {
    	"XXX", "XYX", "XXX", 'Y', Items.BREAD, 'X', Items.GOLD_NUGGET	
    	});


    	GameRegistry.addShapedRecipe( new ItemStack(GOLDEN_CHICKEN, 1), new Object [] {
    	"XXX", "XYX", "XXX", 'Y', Items.CHICKEN, 'X', Items.GOLD_NUGGET	
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(GOLDEN_COD, 1), new Object [] {
    	"XXX", "XYX", "XXX", 'Y', Items.COOKED_FISH, 'X', Items.GOLD_NUGGET	
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(GOLDEN_PORKCHOP, 1), new Object [] {
    	"XXX", "XYX", "XXX", 'Y', Items.PORKCHOP, 'X', Items.GOLD_NUGGET	
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(WATERMELON_SLICE, 1), new Object [] {
    	"XXX", "XYX", "XXX", 'Y', Items.MELON, 'X', Items.GOLD_NUGGET	
    	});

    	GameRegistry.addShapedRecipe( new ItemStack(GOLDEN_MUSHROOM_STEW, 1), new Object [] {
    	"XXX", "XYX", "XXX", 'Y', Items.MUSHROOM_STEW, 'X', Items.GOLD_NUGGET	
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(GOLDEN_STEAK, 1), new Object [] {
    	"XXX", "XYX", "XXX", 'Y', Items.COOKED_BEEF, 'X', Items.GOLD_NUGGET	
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(GOLDEN_COOKIE, 1), new Object [] {
    	"XXX", "XYX", "XXX", 'Y', Items.COOKIE, 'X', Items.GOLD_NUGGET	
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(GOLDEN_POTATO, 1), new Object [] {
    	"XXX", "XYX", "XXX", 'Y', Items.POTATO, 'X', Items.GOLD_NUGGET	
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(GOLDEN_PUMPKIN_PIE, 1), new Object [] {
    	"XXX", "XYX", "XXX", 'Y', Items.PUMPKIN_PIE, 'X', Items.GOLD_NUGGET	
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(GOLDEN_ROTTON_FLESH, 1), new Object [] {
    	"XXX", "XYX", "XXX", 'Y', Items.ROTTEN_FLESH, 'X', Items.GOLD_NUGGET	
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(GOLDEN_CARROT, 1), new Object [] {
    	"XXX", "XYX", "XXX", 'Y', Items.CARROT, 'X', Items.GOLD_NUGGET	
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(GOLDEN_CANDYCANE, 1), new Object [] {
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(ENCHANTED_GOLDEN_CARROT, 1), new Object [] {
    	"XXX", "XYX", "XXX", 'Y', Items.CARROT, 'X', Items.GOLD_INGOT	
    	});

    	GameRegistry.addShapedRecipe( new ItemStack(ENCHANTED_GOLDEN_STEAK, 1), new Object [] {
    	"XXX", "XYX", "XXX", 'Y', Items.COOKED_BEEF, 'X', Items.GOLD_INGOT	
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(ENCHANTED_GOLDEN_COD, 1), new Object [] {
    	"XXX", "XYX", "XXX", 'Y', Items.COOKED_FISH, 'X', Items.GOLD_INGOT	
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(ENCHANTED_GOLDEN_COOKIE, 1), new Object [] {
    	"XXX", "XYX", "XXX", 'Y', Items.COOKIE, 'X', Items.GOLD_INGOT	
    	});
    	GameRegistry.addShapedRecipe( new ItemStack(ENCHANTED_GOLDEN_CANDYCANE, 1), new Object [] {
    	"XXX", "XYX", "XXX", 'Y', FeatureCreepMC.CANDY_CANE, 'X', Items.GOLD_INGOT	
    	});

    	GameRegistry.addShapedRecipe( new ItemStack(RADDISH_STEW, 1), new Object [] {
    	...
    	//ULTIMATE_APPLE = new RawBacon(6063, 15, true).setUnlocalizedName("ultimate_apple");
    	  ...
    	  GameRegistry.addShapedRecipe(new ItemStack(ULTIMATE_SWORD), new Object[] 
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(ULTIMATE_PICKAXE), new Object[] 
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(ULTIMATE_SHOVEL), new Object[] 
    	...
    	GameRegistry.addShapedRecipe( new ItemStack(ULTIMATE_HOE), new Object[] 
...
public static final Block AMETHYST_ORE = new GemOre("amethyst_ore", Material.IRON, 4, 10, 10, null, DimensionType.OVERWORLD, 0, 200, 5, 15,BlockMatcher.forBlock(Blocks.STONE), FeatureCreepMC.AMETHYST);
