...
public class FCHoe extends HoeItem implements FCItemAPI
{
	public String public_modid;
	public String public_name;
	public int number_id;
	public ItemGroup default_tab;
	public FCHoe(int id, String modid, String name, ItemGroup group, FCToolMaterial material, int attackDamage, float attackSpeed)
	{
