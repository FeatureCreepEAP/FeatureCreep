...
public class GameRegistries {
	...
	{
		return Registry.Registry.get(new Identifier(registry_name));
	}
	
	public static Block getBlockFromGameRegistries(int id)
	{
		return Registry.Registry.get(id);//May not work
	}
	
	public static boolean BlockKeyExistsInRegistry(String registry_name)
	{
		return Registry.Registry.containsId(new Identifier(registry_name));
	}
