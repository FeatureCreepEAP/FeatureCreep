...
public static final Block AMETHYST_ORE = new BasicOre(Block.Settings.of(Material.METAL));
public static final Block RUBY_ORE = new BasicOre(Block.Settings.of(Material.METAL));
public static final Block TIGERS_EYE_ORE = new BasicOre(Block.Settings.of(Material.METAL));
public static final Block TITANIUM_ORE = new BasicOre(Block.Settings.of(Material.METAL));
public static final Block URANIUM_ORE = new BasicOre(Block.Settings.of(Material.METAL));
public static final Block ALUMINIUM_ORE = new BasicOre(Block.Settings.of(Material.METAL));
public static final Block SALT_ORE = new BasicOre(Block.Settings.of(Material.METAL));
public static final Block UNPROCESSED_OIL_ORE = new BasicOre(Block.Settings.of(Material.METAL));
public static final Block GASOLINE_PETROL_ORE = new BasicOre(Block.Settings.of(Material.METAL));
