...
public class FCItemAsDMR 
{
	...
	public FCItemAsDMR(int id, String modid, String name, FCCreativeTab group)
	{
	public_modid = modid;
	public_name = name;
	...
	public FCItemAsDMR(int id, String modid, String name, VanillaCreativeTab group)
	{
		public_modid = modid;
		public_name = name;
	...
	public void registerModels(FCItemAsDMR item) {
	...
	public String getDefaultCreativeTab() {
		// TODO Auto-generated method stub
		return default_tab;
	}
