...
@Override public featurecreep.api.bg.items.ItemFieldHolder holder() {	return holder;	}
	...
	//Getters and Vanilla constructors are not in userdev, if you know what you are doing you can use Mirror or Reflection
	
	//public Item vanilla_item; //BE VERY CAREFUL
	/*
	public VanillaItem(Item item, String registry_name)
	{
		item	= vanilla_item; //Set the Item to be returned
		...
		setDefaultCreativeTab(FCCreativeTabs.TOOLS.get()); //May not work on all versions, we may need to remove this or use random tab. I just remembered that Vanilla Creative Tabs still use FCCreativeTabs, may need to change that
