...
private static ConfiguredFeature<?, ?> ORE_TIGERS_EYE_OVERWORLD = Feature.ORE
.configure(new OreFeatureConfig(
  OreFeatureConfig.Rules.BASE_STONE_OVERWORLD,
  TIGERS_EYE_ORE.getDefaultState(),
  7)) // Vein size
.range(new RangeDecoratorConfig(
  // You can also use one of the other height providers if you don't want a uniform distribution
  UniformHeightProvider.create(YOffset.aboveBottom(0), YOffset.fixed(64)))) // Inclusive min and max height
...
private static ConfiguredFeature<?, ?> ORE_OIL_OVERWORLD = Feature.ORE
.configure(new OreFeatureConfig(
  OreFeatureConfig.Rules.BASE_STONE_OVERWORLD,
  UNPROCESSED_OIL_ORE.getDefaultState(),
  8)) // Vein size
.range(new RangeDecoratorConfig(
  // You can also use one of the other height providers if you don't want a uniform distribution
  UniformHeightProvider.create(YOffset.aboveBottom(0), YOffset.fixed(64)))) // Inclusive min and max height
...
private static ConfiguredFeature<?, ?> ORE_GASOLINE_PETROL_OVERWORLD = Feature.ORE
.configure(new OreFeatureConfig(
  OreFeatureConfig.Rules.BASE_STONE_OVERWORLD,
  GASOLINE_PETROL_ORE.getDefaultState(),
  8)) // Vein size
.range(new RangeDecoratorConfig(
  // You can also use one of the other height providers if you don't want a uniform distribution
  UniformHeightProvider.create(YOffset.aboveBottom(0), YOffset.fixed(64)))) // Inclusive min and max height
...
.repeat(18); // Number of veins per chunk
  ...
  //      Registry.register(Registry.ITEM, new Identifier("featurecreep", "amethyst_sword"), AMETHYST_SWORD);
    ...
    //    Registry.register(Registry.ITEM, new Identifier("featurecreep", "amethyst_axe"), AMETHYST_AXE);
        ...
        RegistryKey<ConfiguredFeature<?, ?>> oreAmethystOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
        	      new Identifier("featurecreep", "ore_amethyst_overworld"));
        	    ...
        	    BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, oreAmethystOverworld);
        	      ...
        	      RegistryKey<ConfiguredFeature<?, ?>> oreRubyOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
                	      new Identifier("featurecreep", "ore_ruby_overworld"));
                	    ...
                	    BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, oreRubyOverworld);
                	      ...
                	      RegistryKey<ConfiguredFeature<?, ?>> oreTitaniumOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
                        	      new Identifier("featurecreep", "ore_titanium_overworld"));
                        	    ...
                        	    BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, oreTitaniumOverworld);
                        	      ...
                        	      RegistryKey<ConfiguredFeature<?, ?>> oreUraniumOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
                                	      new Identifier("featurecreep", "ore_uranium_overworld"));
...
RegistryKey<ConfiguredFeature<?, ?>> oreTigersEyeOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
new Identifier("featurecreep", "ore_tigers_eye_overworld"));
Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreTigersEyeOverworld.getValue(), ORE_TIGERS_EYE_OVERWORLD);
...
RegistryKey<ConfiguredFeature<?, ?>> oreSaltOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
	      new Identifier("featurecreep", "ore_salt_overworld"));
	    ...
	    BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, oreSaltOverworld);
	     ...
	     RegistryKey<ConfiguredFeature<?, ?>> oreOilOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
       	      new Identifier("featurecreep", "ore_oil_overworld"));
       	    Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreOilOverworld.getValue(), ORE_OIL_OVERWORLD);
       	    BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, oreOilOverworld);
       	
            RegistryKey<ConfiguredFeature<?, ?>> oreGasolinePetrolOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
          	      new Identifier("featurecreep", "ore_gasolinepetrol_overworld"));
          	    Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreGasolinePetrolOverworld.getValue(), ORE_GASOLINE_PETROL_OVERWORLD);
          	    BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, oreGasolinePetrolOverworld);
          	
	
          	  RegistryKey<ConfiguredFeature<?, ?>> oreAluminiumOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
              	      new Identifier("featurecreep", "ore_aluminium_overworld"));
              	    Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreAluminiumOverworld.getValue(), ORE_ALUMINIUM_OVERWORLD);
