...
import featurecreep.loader.FCLoaderBasicR6;
...
public class FeatureCreep {
	...
	public static FCLoaderBasic loader = new FCLoaderBasicR6(new Path[] {new File(modpath).toPath()}, new Path[] {}, packages_needed, 4, true);
