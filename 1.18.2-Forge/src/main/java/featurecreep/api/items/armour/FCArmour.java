...
public class FCArmour extends ArmorItem implements FCItemAPI{
	...
	public FCArmour(int id, String modid, String name, ItemGroup group, FCArmourMaterial material, FCArmourSlot slot) {
		super(material, slot.getSlot(), new Item.Settings().group(group));
...
//	    ForgeRegistries.ITEMS.register(this);
	...
	public FCArmour(int id, String modid, String name, VanillaCreativeTab group, FCArmourMaterial material, FCArmourSlot slot) {
		this(id, modid, name, VanillaCreativeTab.getVanillaGroupFromString(group), material, slot);
		// TODO Auto-generated constructor stub
