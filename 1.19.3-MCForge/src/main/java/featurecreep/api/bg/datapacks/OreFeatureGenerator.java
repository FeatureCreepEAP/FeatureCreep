...
File modifier = new File(DataPackLoader.datapacklocation+"data/featurecreep/forge/biome_modifier/"+biomemodifier.hashCode()+".json");//Gotta also change this to base64
