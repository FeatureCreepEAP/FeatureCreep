...
public class FCAxe extends AxeItem implements ToolsAPI<FCAxe>
{
	...
	public featurecreep.api.bg.blocknitem.BlocknItemFieldHolder holder = new featurecreep.api.bg.blocknitem.BlocknItemFieldHolder();
	@Override public featurecreep.api.bg.blocknitem.BlocknItemFieldHolder holder() {	return holder;	}
