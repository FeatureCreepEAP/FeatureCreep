...
public class DeskCrafting {
	...
	public static DeskRecipe find(Player pl){
		return find(nameof(pl.getCrafting(0)),
				nameof(pl.getCrafting(1)),
				nameof(pl.getCrafting(2)),
				nameof(pl.getCrafting(3)));
	}
	...
	private static String nameof(InventoryContainer ic) {
