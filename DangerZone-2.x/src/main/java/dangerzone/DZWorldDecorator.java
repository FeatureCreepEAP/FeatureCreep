...
public class DZWorldDecorator extends WorldDecorator {
	...
	public static StuffList[] things = new StuffList[] { 
			...
			new StuffList(Items.scubatanks, 1, 2, 25),
			new StuffList(Items.scubamask, 1, 2, 25),
			new StuffList(Items.bullets, 4, 16, 25),
			new StuffList(Items.pistol, 1, 1, 15),
			new StuffList(Items.semipistol, 1, 1, 10),
			new StuffList(Items.autopistol, 1, 1, 5),
