 ...
 * mny = minumum y level
 * mxy - maximum y level
 * ch = chance 1-1000   1 = 0.1%, 1000 = 100%
 ...
 */
	...
	//chance is normal, but then only 1 in 16 success as well.
	public static void registerSpawnRare(Entity e, Dimension d, Biome bio, int mny, int mxy, int chance, int howmany, int ty, int prm){
		SpawnlistEntry no = new SpawnlistEntry();
		no.whatToSpawn = e;
		no.dimensionname = null;
		if(d != null){
