...
public class PacketTypes {
	...
	public static final int SPAWNPARTICLESSCALED = 0xb6;
	public static final int SPAWNPARTICLESSCALEDWITHDIRECTION = 0xb7;
	public static final int RENDERDISTANCECHANGE = 0xb8;
