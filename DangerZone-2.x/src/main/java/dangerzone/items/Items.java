...
public class Items {
	...
	public static Item woodenhoe = new ItemHoe("DangerZone:Wooden Hoe", "res/items/woodenhoe.png", 200, 1, 1);
	...
	public static Item stoneshovel = new ItemShovel("DangerZone:Stone Shovel", "res/items/stoneshovel.png", 600, 4, 3);
	public static Item stonehoe = new ItemHoe("DangerZone:Stone Hoe", "res/items/stonehoe.png", 400, 1, 2);
	...
	public static Item copperhoe = new ItemHoe("DangerZone:Copper Hoe", "res/items/copperhoe.png", 500, 2, 3);
	...
	public static Item tinshovel = new ItemShovel("DangerZone:Tin Shovel", "res/items/tinshovel.png", 1200, 6, 6);
	public static Item tinhoe = new ItemHoe("DangerZone:Tin Hoe", "res/items/tinhoe.png", 600, 2, 4);
	...
	public static Item silvershovel = new ItemShovel("DangerZone:Silver Shovel", "res/items/silvershovel.png", 1400, 7, 7);
	public static Item silverhoe = new ItemHoe("DangerZone:Silver Hoe", "res/items/silverhoe.png", 800, 3, 5);
	...
	public static Item platinumshovel = new ItemShovel("DangerZone:Platinum Shovel", "res/items/platinumshovel.png", 1600, 10, 12);
	public static Item platinumhoe = new ItemHoe("DangerZone:Platinum Hoe", "res/items/platinumhoe.png", 1000, 5, 10);
	...
	public static Item pistol = new ItemPistol("DangerZone:.22 Pistol", "res/items/pistol.png", 12, 31); //damage, rounds it holds (+1)
	public static Item semipistol = new ItemSemiPistol("DangerZone:.22 Semi-Auto Pistol", "res/items/pistol.png", 12, 31); //damage, rounds it holds (+1)
	public static Item autopistol = new ItemAutoPistol("DangerZone:.22 Full-Auto Pistol", "res/items/autopistol.png", 12, 151); //damage, rounds it holds (+1)
	public static Item bullets = new ItemBullets("DangerZone:Bullets", "res/items/bullets.png"); //generic bullets
	public static Item magnum = new ItemMagnum("DangerZone:.357 Magnum", "res/items/magnum.png", 150, 7); //damage, rounds it holds (+1)
	public static Item shotgun = new ItemShotgun("DangerZone:Shotgun", "res/items/shotgun.png", 300, 3); //damage, rounds it holds (+1)
	...
	public static void renderMeHeld(WorldRenderer wr, Entity e, InventoryContainer ic, boolean isdisplay){
		int itemid;
		if(ic == null)return;
		itemid = ic.iid;
		if(itemid <= 0)return;
		...
		Items.ItemArray[itemid].renderMeHeld(wr, e, ic, isdisplay);
	}
