...
public class ItemFireball extends Item {
	public int power = 10;
	public ItemFireball(String n, String txt, int pwr) {
		super(n, txt);
		burntime = 12;
		power = pwr;
	}
	...
	public boolean onRightClick(Entity holder, Entity clickedon, InventoryContainer ic){
		...
		if(holder.world.isServer){
			ThrownFireball e = (ThrownFireball)holder.world.createEntityByName("DangerZone:ThrownFireball", 
					holder.dimension, 
			...
			if(e != null){
				...
				e.setIID(ic.iid);
				e.thrower = holder;
				e.explosive_power = this.power;//really fire power... it goes out a low further...
			...
			holder.world.playSound("DangerZone:bow", holder.dimension, holder.posx, holder.posy+holder.getHeight(), holder.posz, 0.6f, 1.0f+((holder.world.rand.nextFloat()-holder.world.rand.nextFloat())*0.3f));
			return true;
		}
