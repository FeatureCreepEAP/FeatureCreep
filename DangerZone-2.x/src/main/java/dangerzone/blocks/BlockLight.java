...
public class BlockLight extends Block {
	...
	public BlockLight(String n, String txt, int hardness) {
		super(n, txt);
		isStone = true;
		maxdamage = hardness;
		brightness = 0.25f;
		mindamage = 5; //at least a pickaxe!
	...
	public int getItemDrop(Player p, World w, int d, int x, int y, int z){
		//Player can be NULL! Make sure you check!
		Utils.spawnExperience(5, w, d, (double)x+0.5f, (double)y+0.5f, (double)z+0.5f);
		return Items.light.itemID; //override this if you want to drop an item instead of a block.
	}
