 ...
 * 
 */
public class BlockWaterSpout extends Block {
	...
	public BlockWaterSpout(String n, String txttop, String txt2, String txt3) {
		super(n, "");
		isStone = true;
		maxdamage = 20;
		mindamage = 2; 
	...
	public void tickMe(World w, int d, int x, int y, int z){	
		...
		if(spout){
			int howmany = 50 + w.rand.nextInt(50);
			...
			if(w.rand.nextInt(500) == 1){
				...
				if(e != null){
					...
					e.motiony = 0.75f+(DangerZone.rand.nextFloat()/4);
