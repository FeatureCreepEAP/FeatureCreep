...
public class EntityBlockItem extends Entity {
	...
	public EntityBlockItem(World w){
		...
		motionx = (DangerZone.rand.nextFloat()-DangerZone.rand.nextFloat()) * 0.006f;
		motionz = (DangerZone.rand.nextFloat()-DangerZone.rand.nextFloat()) * 0.006f;
		setFlying(true);
		has_inventory = true;
	}
	...
	public void update( float deltaT){
		...
		if(this.world.isServer){
			...
			if(this.world.rand.nextInt(200) == 1){
				f = this.world.rand.nextFloat() * 0.01f;
				//System.out.printf("Random f = %f\n", f);
				motiony += f;
			}
			if(this.world.rand.nextInt(300) == 1){
				f = (this.world.rand.nextFloat()-this.world.rand.nextFloat()) * 0.006f;
				//System.out.printf("Random f = %f\n", f);
				motionx += f;
			}
			if(this.world.rand.nextInt(300) == 1){
