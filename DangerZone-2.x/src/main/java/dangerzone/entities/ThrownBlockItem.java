...
public class ThrownBlockItem extends Entity {
	...
	public void doHitSomething(boolean hb, double x, double y, double z, boolean he, Entity ent){
		...
		if(he && ent != null){
			...
			if(getIID() != 0){
				Utils.spawnParticlesFromServerScaled(world, "DangerZone:ParticleItem", 25, this.dimension, x, y, z, getIID(), 0.5f);
			}else{
				Utils.spawnParticlesFromServerScaled(world, "DangerZone:ParticleBreak", 25, this.dimension, x, y, z, getBID(), 0.5f);
			}
		}
