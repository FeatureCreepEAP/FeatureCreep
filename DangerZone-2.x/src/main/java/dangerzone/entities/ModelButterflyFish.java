...
public class ModelButterflyFish extends ModelBase
{
  ...
  public ModelButterflyFish()
  {
      ...
      body.addBox(0F, 0F, 0F, 2, 10, 13);
      body.setRotationPoint(-1F, 11F, -7F);
      body.setTextureSize(64, 32);
      body.mirror = true;
      setRotation(body, 0F, 0F, 0F);
      topfin = new ModelRenderer(this, 31, 0);
      topfin.addBox(-0.5F, -2F, 0F, 1, 2, 6);
      topfin.setRotationPoint(0F, 12F, -5F);
      topfin.setTextureSize(64, 32);
      topfin.mirror = true;
      setRotation(topfin, 0.1396263F, 0F, 0F);
      tailfin = new ModelRenderer(this, 31, 9);
      ...
      lfin = new ModelRenderer(this, 18, 24);
