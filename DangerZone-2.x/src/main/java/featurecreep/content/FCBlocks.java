...
public class FCBlocks {
	...
	public static FCOre TIGERS_EYE_ORE = new FCOre(706, FeatureCreep.modid, "tigers_eye_ore", FCCreativeTabs.BUILDING_BLOCKS, VanillaBlockMaterials.STONE, 1, new BlockDropArrayObject[] {BlockDropArrayObjects.SELF.setRequiredToolType(ToolTypes.PICKAXE)}, FCItems.TIGERS_EYE_INGOT).isSingleSided(true);
	public static FCOre TITANIUM_ORE = new FCOre(707, FeatureCreep.modid, "titanium_ore", FCCreativeTabs.BUILDING_BLOCKS, VanillaBlockMaterials.STONE, 1, new BlockDropArrayObject[] {BlockDropArrayObjects.SELF.setRequiredToolType(ToolTypes.PICKAXE)}, FCItems.TITANIUM_INGOT).isSingleSided(true);
	public static FCOre URANIUM_ORE = new FCOre(708, FeatureCreep.modid, "uranium_ore", FCCreativeTabs.BUILDING_BLOCKS, VanillaBlockMaterials.STONE, 1, new BlockDropArrayObject[] {BlockDropArrayObjects.SELF.setRequiredToolType(ToolTypes.PICKAXE)}, FCItems.URANIUM_INGOT).isSingleSided(true);
	public static FCOre ALUMINIUM_ORE = new FCOre(709, FeatureCreep.modid, "aluminium_ore", FCCreativeTabs.BUILDING_BLOCKS, VanillaBlockMaterials.STONE, 1, new BlockDropArrayObject[] {BlockDropArrayObjects.SELF.setRequiredToolType(ToolTypes.PICKAXE)}, FCItems.ALUMINIUM_INGOT).isSingleSided(true);
	...
	public static FCBlock AMETHYST_BLOCK = new FCBlock(712, FeatureCreep.modid, "amethyst_block", FCCreativeTabs.BUILDING_BLOCKS, VanillaBlockMaterials.STONE, 1, new BlockDropArrayObject[] {BlockDropArrayObjects.SELF.setRequiredToolType(ToolTypes.PICKAXE)}).isSingleSided(true);
	public static FCBlock RUBY_BLOCK = new FCBlock(713, FeatureCreep.modid, "ruby_block", FCCreativeTabs.BUILDING_BLOCKS, VanillaBlockMaterials.STONE, 1, new BlockDropArrayObject[] {BlockDropArrayObjects.SELF.setRequiredToolType(ToolTypes.PICKAXE)}).isSingleSided(true);
	public static FCBlock TIGERS_EYE_BLOCK = new FCBlock(714, FeatureCreep.modid, "tigers_eye_block", FCCreativeTabs.BUILDING_BLOCKS, VanillaBlockMaterials.STONE, 1, new BlockDropArrayObject[] {BlockDropArrayObjects.SELF.setRequiredToolType(ToolTypes.PICKAXE)}).isSingleSided(true);
	public static FCBlock TITANIUM_BLOCK = new FCBlock(715, FeatureCreep.modid, "titanium_block", FCCreativeTabs.BUILDING_BLOCKS, VanillaBlockMaterials.STONE, 1, new BlockDropArrayObject[] {BlockDropArrayObjects.SELF.setRequiredToolType(ToolTypes.PICKAXE)}).isSingleSided(true);
	public static FCBlock URANIUM_BLOCK = new FCBlock(716, FeatureCreep.modid, "uranium_block", FCCreativeTabs.BUILDING_BLOCKS, VanillaBlockMaterials.STONE, 1, new BlockDropArrayObject[] {BlockDropArrayObjects.SELF.setRequiredToolType(ToolTypes.PICKAXE)}).isSingleSided(true);
	public static FCBlock ALUMINIUM_BLOCK = new FCBlock(717, FeatureCreep.modid, "aluminium_block", FCCreativeTabs.BUILDING_BLOCKS, VanillaBlockMaterials.STONE, 1, new BlockDropArrayObject[] {BlockDropArrayObjects.SELF.setRequiredToolType(ToolTypes.PICKAXE)}).isSingleSided(true);
