...
public class LootProvider extends LootTablesProvider {
...
//    @Override
//    protected List<Pair<Supplier<Consumer<BiConsumer<ModelIdentifier, Builder>>>, LootContextType>> getTables() {
