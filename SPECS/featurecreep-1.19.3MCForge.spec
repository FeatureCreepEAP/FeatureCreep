...
Release:        1.19.3MCForge.el9%{?dist}#A release number for if you have more than 1 release. The dist part is to indicate which loader and version is being used, such as FeatureCreep 4 would be fc4
...
#%configure
#%make_build
buildfpm_maven %{?sources_location}/1.19.3MCForge #This is the main command you need to look at as it is responsible for packaging your maven project and adding all the extra required files to fpm and sfpm files
remap(/home/rhel/fcdependencies/featurecreep-intermediary-1.19.3-parchsrg.pdme,/home/rhel/fcdependencies/1.19.3MCForge/)
rm -rf %{?build_root}/*
