...
{
this(durability, protection, enchantability, FCIngredient.ingredientFromItem((Block)repair), name, toughness, knockback_resistance);
}
...
{
this(durability, protection, enchantability, FCIngredient.ingredientFromItem((Item)repair), name, toughness, knockback_resistance);
}
