...
public class FCRegistries
{
	...
	public static void registerBlock(FCBlock block)
	{
		...
		Registry.register(Registry.ITEM, new Identifier(block.public_modid, block.public_name), new BlockItem(block, new Item.Settings().group(block.default_tab)));
	...
	public static void registerBlock(FCBlockAPI block)
	{
		...
		Registry.register(Registry.ITEM, new Identifier(block.getModId(), block.getUnlocName()), new BlockItem((Block)block, new Item.Settings().group(block.getDefaultCreativeTab())));
