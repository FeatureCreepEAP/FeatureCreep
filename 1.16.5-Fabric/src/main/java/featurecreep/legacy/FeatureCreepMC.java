...
public static <FC extends FeatureConfig> ConfiguredFeature<FC, ?> register(String key, ConfiguredFeature<FC, ?> configuredFeature) {
 ...
 //       Registry.register(Registry.ITEM, new Identifier("featurecreep", "amethyst_hoe"), AMETHYST_HOE);
   //     Registry.register(Registry.ITEM, new Identifier("featurecreep", "amethyst_axe"), AMETHYST_AXE);
        ...
        FuelRegistry.INSTANCE.add((ItemConvertible)GASOLINE_PETROL, Integer.valueOf(40));
         ...
         final ConfiguredFeature<?, ?> ORE_RUBY_LAVA = register("ore_ruby_lava", Feature.ORE.configure(new OreFeatureConfig(new BlockMatchRuleTest(Blocks.LAVA), RUBY_ORE.getDefaultState(), 8)).decorate(Decorator.DEPTH_AVERAGE.configure(new DepthAverageDecoratorConfig(24, 24))).repeat(10));
         final ConfiguredFeature<?, ?> ORE_AMETHYST = register("ore_amethyst", Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, AMETHYST_ORE.getDefaultState(), 4)).decorate(Decorator.DEPTH_AVERAGE.configure(new DepthAverageDecoratorConfig(28, 24))).repeat(4));
         final ConfiguredFeature<?, ?> ORE_SAPPHIRE = register("ore_sapphire", Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, AMETHYST_ORE.getDefaultState(), 4)).decorate(Decorator.DEPTH_AVERAGE.configure(new DepthAverageDecoratorConfig(28, 24))).repeat(4));
         final ConfiguredFeature<?, ?> ORE_URANIUM = register("ore_uranium", Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, URANIUM_ORE.getDefaultState(), 3)).decorate(Decorator.DEPTH_AVERAGE.configure(new DepthAverageDecoratorConfig(12, 12))).repeat(2));
         final ConfiguredFeature<?, ?> ORE_TITANIUM = register("ore_titanium", Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, TITANIUM_ORE.getDefaultState(), 3)).decorate(Decorator.DEPTH_AVERAGE.configure(new DepthAverageDecoratorConfig(12, 12))).repeat(2));
         final ConfiguredFeature<?, ?> ORE_TIGERS_EYE = register("ore_tigers_eye", Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, TIGERS_EYE_ORE.getDefaultState(), 7)).decorate(Decorator.DEPTH_AVERAGE.configure(new DepthAverageDecoratorConfig(24, 24))).repeat(5));
         final ConfiguredFeature<?, ?> ORE_ALUMINIUM = register("ore_aluminium", Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, SALT_ORE.getDefaultState(), 6)).decorate(Decorator.DEPTH_AVERAGE.configure(new DepthAverageDecoratorConfig(64, 64))).repeat(12));
         final ConfiguredFeature<?, ?> ORE_SALT = register("ore_salt", Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, SALT_ORE.getDefaultState(), 8)).decorate(Decorator.DEPTH_AVERAGE.configure(new DepthAverageDecoratorConfig(48, 48))).repeat(18));
         final ConfiguredFeature<?, ?> ORE_OIL = register("ore_oil", Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, UNPROCESSED_OIL_ORE.getDefaultState(), 20)).decorate(Decorator.DEPTH_AVERAGE.configure(new DepthAverageDecoratorConfig(48, 48))).repeat(20));
         final ConfiguredFeature<?, ?> ORE_GAS = register("ore_gas", Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, GASOLINE_PETROL_ORE.getDefaultState(), 10)).decorate(Decorator.DEPTH_AVERAGE.configure(new DepthAverageDecoratorConfig(48, 48))).repeat(10));

         RegistryKey<ConfiguredFeature<?, ?>> oreRubyOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
        	        new Identifier("ore_ruby_lava"));
    ...
    RegistryKey<ConfiguredFeature<?, ?>> oreTigersEyeOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
   	        new Identifier("ore_tigers_eye"));
    BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, oreTigersEyeOverworld);

    RegistryKey<ConfiguredFeature<?, ?>> oreAluminiumOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
   	        new Identifier("ore_aluminium"));
    ...
    RegistryKey<ConfiguredFeature<?, ?>> oreSaltOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
   	        new Identifier("ore_salt"));
    BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, oreSaltOverworld);

    RegistryKey<ConfiguredFeature<?, ?>> oreOilOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
   	        new Identifier("ore_oil"));
    BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, oreOilOverworld);

    RegistryKey<ConfiguredFeature<?, ?>> oreGasOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
   	        new Identifier("ore_gas"));
    BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, oreGasOverworld);
	}
