...
public class Windigo extends EntityModel<WindigoEntity> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new ModelIdentifier("featurecreep", "windigo"), "main");
	private final ModelPart e41;
	private final ModelPart bb_main;

	public Windigo(ModelPart root) {
	...
	@Override
	public void setAngles(WindigoEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
