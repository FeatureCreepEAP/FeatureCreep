...
/*
		 ...
		 final RegistryEntry<ConfiguredFeature<DiskFeatureConfig, ?>> ORE_SALT_BLOCK_OVERWORLD = ConfiguredFeatures.register("salt_block_ore", Feature.DISK, new DiskFeatureConfig(new PredicatedStateProvider(BlockStateProvider.of(Blocks.DIRT), List.of(new PredicatedStateProvider.Rule(BlockPredicate.not(BlockPredicate.eitherOf(BlockPredicate.solid(Direction.UP.getVector()), BlockPredicate.matchingFluids(Direction.UP.getVector(), Fluids.WATER))), BlockStateProvider.of(SALT_BLOCK)))), BlockPredicate.matchingBlocks(List.of(Blocks.DIRT, Blocks.MUD)), UniformIntProvider.create(2, 6), 2));
		 ...
		 final RegistryEntry<ConfiguredFeature<DiskFeatureConfig, ?>> ORE_BLACK_SAND_OVERWORLD = ConfiguredFeatures.register("black_sand_ore", Feature.DISK, new DiskFeatureConfig(new PredicatedStateProvider(BlockStateProvider.of(Blocks.DIRT), List.of(new PredicatedStateProvider.Rule(BlockPredicate.not(BlockPredicate.eitherOf(BlockPredicate.solid(Direction.UP.getVector()), BlockPredicate.matchingFluids(Direction.UP.getVector(), Fluids.WATER))), BlockStateProvider.of(BLACK_SAND)))), BlockPredicate.matchingBlocks(List.of(Blocks.DIRT, Blocks.MUD)), UniformIntProvider.create(2, 6), 2));
