...
public class OrespawnBasicFeatureParser {
	...
	public static ArrayList<RegistryEntry<PlacedFeature>> placed = new ArrayList<RegistryEntry<PlacedFeature>>();
...
public static void applyOres(ChunkGenerator gen, StructureWorldAccess world, Chunk chunk, StructureAccessor structureAccessor)
{
	...
	for(int i=0; i<placed.size(); i++) {
		placed.get(i).value().generate(world, gen, chunkRandom, blockPos);
	}
