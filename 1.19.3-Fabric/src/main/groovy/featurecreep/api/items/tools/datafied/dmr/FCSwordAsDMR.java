...
public class FCSwordAsDMR extends FCItemAsDMR 
{
	...
	public FCSwordAsDMR(int id, String modid, String name, FCCreativeTab group, FCToolMaterial material, int attackDamage, int attackSpeed)
	{
super (id, modid,name, group);
	...
	public FCSwordAsDMR(int id, String modid, String name, VanillaCreativeTab group, FCToolMaterial material, int attackDamage, int attackSpeed)
	{
		super (id, modid,name, group);
		public_modid = modid;
		public_name = name;
