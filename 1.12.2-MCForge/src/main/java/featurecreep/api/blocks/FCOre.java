...
public class FCOre extends BlockOre implements FCBlockAPI {
	  ...
	  public FCOre(int id, String modid, String name, CreativeTabs group, VanillaBlockMaterial material, int strength, BlockDropArrayObject[] drops, Object ore_material) {
	    super();
	    public_modid = modid;
	    public_name = name;
	    registerModels(this);
