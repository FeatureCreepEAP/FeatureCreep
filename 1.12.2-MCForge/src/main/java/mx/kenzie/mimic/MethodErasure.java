...
public class MethodErasure implements Constable, Serializable{

	public Class<?> owner;
	public String name;
	public Class<?>[] parameters;
	
public  MethodErasure(Class<?> owner, String name, Class<?>... parameters)  {
    this.owner = owner;
    this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MethodErasure)) return false;
        final MethodErasure erase = (MethodErasure)o;
        return Objects.equals(name, erase.name) && Arrays.equals(parameters, erase.parameters);
    }
